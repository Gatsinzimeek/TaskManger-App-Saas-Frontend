...
const PageNotFound = () => {
  return (
    <div>
        ...
        <button className="bg-primary text-white bg-[#007DFE] cursor-pointer px-4 py-2 rounded-md block mx-auto mt-4 font-family" onClick={() => window.location.href = '/'}>Go Back Home</button>
    </div>
  )
}
