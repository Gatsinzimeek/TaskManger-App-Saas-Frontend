  ...
  return (
    <div className='flex justify-between items-center p-4 bg-white text-black pt-12 pb-8 h-16 w-full shadow-sm'>
        ...
        <div className='flex items-center gap-4'>
          <div className="relative"><input type="text" placeholder="Search..." className='bg-gray-50 text-gray-400 placeholder:text-gray-400 focus:outline-none pl-15 rounded-xl p-2 ' /><button className='cursor-pointer'><FaSearch className='absolute left-5 top-1/2 transform -translate-y-1/2 font-bold text-blue-500' /></button></div>
